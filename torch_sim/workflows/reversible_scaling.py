...
def npt_crescale_rs_init(
    ...
    *,
    ...
    return ReversibleScalingMDState.from_state(
        npt_state,
        lambda_=torch.ones(
            npt_state.n_systems, device=npt_state.device, dtype=npt_state.dtype
        ),
        unscaled_energy=npt_state.energy,
    )
...
def run_reversible_scaling_steered_md(  # noqa: C901
    system: SimState,
    model: ModelInterface,
